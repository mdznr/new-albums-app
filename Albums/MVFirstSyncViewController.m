...
- (void)viewDidLoad
{
	...
	self.headLabel = [[UILabel alloc] initWithFrame:CGRectMake(30,
															   startY + 70 - 17 / 2,
															   CGRectGetWidth(self.view.frame) - 60,
															   40)];
	self.headLabel.text = NSLocalizedString(@"Syncing Albums…", @"Syncing Albums Heading");
	self.headLabel.textColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
	...
	self.descriptionLabel = [[UILabel alloc] initWithFrame:CGRectMake(30,
																	  startY + 110 - 10.5,
																	  CGRectGetWidth(self.view.frame) - 60,
																	  200)];
	self.descriptionLabel.text = NSLocalizedString(@"Your Music Library is being browsed to find albums you might enjoy", @"Syncing Description");
	self.descriptionLabel.textColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
