...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
	...
	if ( self )
	{
		...
		topCorners_.drawBlock = ^(UIView *view, CGContextRef ctx)
		{
			...
			[path addLineToPoint:CGPointMake(view.frame.size.width - kMVCellRadius, y)];
			...
			[path addLineToPoint:CGPointMake(view.frame.size.width, y)];
		...
		bottomCorners_.drawBlock = ^(UIView *view, CGContextRef ctx)
		{
			...
			[path addLineToPoint:CGPointMake(view.frame.size.width - kMVCellRadius, y + kMVCellRadius)];
			...
			[path addLineToPoint:CGPointMake(view.frame.size.width, y + kMVCellRadius + 1)];
